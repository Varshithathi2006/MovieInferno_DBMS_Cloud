  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Floating film reels */}
        <div className="absolute top-20 right-10 w-32 h-32 border-4 border-red-500/20 rounded-full animate-spin-slow"></div>
        <div className="absolute bottom-32 left-20 w-24 h-24 border-4 border-pink-500/20 rounded-full animate-spin-reverse"></div>
        
        {/* Gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-red-600 rounded-full opacity-20 blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pink-600 rounded-full opacity-20 blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
        
        {/* Movie strip decoration */}
        <div className="absolute top-0 left-1/3 w-2 h-full bg-gradient-to-b from-transparent via-red-500/10 to-transparent"></div>
        <div className="absolute top-0 right-1/4 w-2 h-full bg-gradient-to-b from-transparent via-pink-500/10 to-transparent"></div>
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-600 via-pink-600 to-red-600 p-8 text-center relative overflow-hidden">
            ...
            <p className="text-white/80 text-sm">Continue your cinematic journey</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="p-8 space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-white/10 bg-white/5 text-red-600 focus:ring-red-500 focus:ring-offset-0 focus:ring-2 transition-all" />
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white hover:bg-white/20 transition-all group"
            >
            ...
            <p className="text-center text-sm text-gray-400">
              ...
              <a href="/signup" className="text-red-400 hover:text-red-300 font-medium transition-colors">
                Sign up
              </a>
            </p>
          </form>
